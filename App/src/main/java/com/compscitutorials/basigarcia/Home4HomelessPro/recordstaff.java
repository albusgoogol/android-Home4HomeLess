...
public class recordstaff extends AppCompatActivity implements View.OnClickListener {

    public static final String UPLOAD_URL = "http://home4homeless.azurewebsites.net/uploadimgpro.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recordstaff);
